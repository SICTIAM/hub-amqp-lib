...
import fr.sictiam.amqp.api.basic.AmqpBasicProducer
...
class AmqpBasicProducerSpec extends AmqpSpec {
  val headers = Map.empty[String, JsValue]

  override implicit val patienceConfig = PatienceConfig(10.seconds)

  "The AmqpBasicProducer" should {
    val queueName: String = s"basic-producer-test-queue-" + System.currentTimeMillis()
