...
class AmqpConnectorsSpec extends AmqpSpec {
  ...
  "The AMQP Connectors" should {
    ...
    //    val connectionProvider = AmqpDetailsConnectionProvider("invalid", 5673).withCredentials(AmqpCredentials("admin","Pa55w0rd")).withHostsAndPorts(immutable.Seq("localhost" -> 5672))
